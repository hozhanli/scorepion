...
import { pgTable, text, varchar, integer, bigint, boolean, jsonb, uniqueIndex, index } from "drizzle-orm/pg-core";
...
export const footballStandings = pgTable("football_standings", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  leagueId: varchar("league_id").notNull(),
...
export const footballTopScorers = pgTable("football_top_scorers", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  leagueId: varchar("league_id").notNull(),
...
export const footballTopAssists = pgTable("football_top_assists", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  leagueId: varchar("league_id").notNull(),
...
export const footballTopYellowCards = pgTable("football_top_yellow_cards", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  leagueId: varchar("league_id").notNull(),
...
export const footballTopRedCards = pgTable("football_top_red_cards", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  leagueId: varchar("league_id").notNull(),
...
export const syncLog = pgTable("sync_log", {
  ...
  error: text("error"),
  syncedAt: bigint("synced_at", { mode: "number" }).notNull().default(sql`extract(epoch from now()) * 1000`),
});
...
export const boostPicks = pgTable("boost_picks", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id),
...
export const achievements = pgTable("achievements", {
  ...
  earnedAt: bigint("earned_at", { mode: "number" }).notNull().default(sql`extract(epoch from now()) * 1000`),
});
...
export const footballFixtureEvents = pgTable("football_fixture_events", {
...
export const footballFixtureLineups = pgTable("football_fixture_lineups", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  fixtureId: integer("fixture_id").notNull(),
  teamId: integer("team_id").notNull(),
  ...
  uniqueIndex("lineup_fixture_player").on(t.fixtureId, t.teamId, t.playerId),
]);

export const footballFixtureStats = pgTable("football_fixture_stats", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  fixtureId: integer("fixture_id").notNull(),
  teamId: integer("team_id").notNull(),
  ...
  uniqueIndex("stats_fixture_team").on(t.fixtureId, t.teamId),
]);

export const footballH2H = pgTable("football_h2h", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  uniqueIndex("h2h_fixture").on(t.fixtureId),
]);
...
export const footballTeamStats = pgTable("football_team_stats", {
  ...
  uniqueIndex("team_stats_league_season").on(t.teamId, t.leagueId, t.season),
]);
