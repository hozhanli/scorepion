...
const NEUTRAL_WASH = ["rgba(238, 240, 244, 0.6)", "rgba(238, 240, 244, 0.0)"] as const;
...
export const tiers = {
  ...
  bronze: {
    bg: "#FCE8D5",
    fg: "#B8793C",
    gradient: ["#E8B88B", "#B8793C"] as const,
    label: "Bronze",
  },
  silver: {
    bg: "#EEF1F5",
    fg: "#7C8A99",
    gradient: ["#E8EDF2", "#B8C2CE"] as const,
    label: "Silver",
  },
  ...
  diamond: {
    bg: "#E0F2FE",
    fg: "#0369A1",
    gradient: [hue._diamondA, hue._diamondB] as const,
    label: "Diamond",
  },
  legend: {
    bg: "#F3E8FF",
    fg: "#7E22CE",
    gradient: [hue._legendA, hue._violet] as const,
    label: "Legend",
  },
};
...
export const elevation = {
  ...
  subtle: {
    web: "0 2px 8px rgba(15, 23, 42, 0.05)",
    offset: { w: 0, h: 2 },
    opacity: 0.05,
    radius: 8,
    elev: 1,
  ...
  soft: {
    web: "0 6px 16px rgba(15, 23, 42, 0.06)",
    offset: { w: 0, h: 4 },
    opacity: 0.06,
    radius: 12,
    elev: 2,
  ...
  medium: {
    web: "0 10px 24px rgba(15, 23, 42, 0.09)",
    offset: { w: 0, h: 8 },
    opacity: 0.09,
    radius: 18,
    elev: 4,
  ...
  strong: {
    web: "0 16px 40px rgba(15, 23, 42, 0.14)",
    offset: { w: 0, h: 14 },
    opacity: 0.14,
    radius: 28,
    elev: 8,
  ...
  glowEmerald: {
    web: "0 12px 28px rgba(0, 166, 81, 0.28)",
    offset: { w: 0, h: 12 },
    opacity: 0.28,
    radius: 24,
    elev: 6,
  ...
  glowFlame: {
    web: "0 12px 28px rgba(255, 107, 53, 0.28)",
    offset: { w: 0, h: 12 },
    opacity: 0.28,
    radius: 24,
    elev: 6,
  ...
  glowGold: {
    web: "0 12px 28px rgba(245, 166, 35, 0.28)",
    offset: { w: 0, h: 12 },
    opacity: 0.28,
    radius: 24,
    elev: 6,
...
/**
 * Emerald tint scale — use for badge backgrounds, soft hover states, fill-on-white.
 * Each key = opacity percentage × 100. 06 = 6%, 30 = 30%.
 * RGB base (0, 166, 81) from hue.emerald #00A651.
 */
export const emeraldTint = {
  6: "rgba(0, 166, 81, 0.06)",
  10: "rgba(0, 166, 81, 0.10)",
  12: "rgba(0, 166, 81, 0.12)",
  16: "rgba(0, 166, 81, 0.16)",
  20: "rgba(0, 166, 81, 0.20)",
  25: "rgba(0, 166, 81, 0.25)",
  30: "rgba(0, 166, 81, 0.30)",
  40: "rgba(0, 166, 81, 0.40)",
} as const;

/**
 * Alert tint scale — use for error states, relegation, danger badges.
 * Each key = opacity percentage × 100.
 * RGB base (239, 68, 68) from palette.red #EF4444.
 */
export const alertTint = {
  ...
  24: "rgba(239, 68, 68, 0.24)",
} as const;

/**
 * Flame tint scale — use for streak urgency, active live states, warm accents.
 * Each key = opacity percentage × 100.
 * RGB base (255, 92, 38) from hue.flame #FF5C26 (adjusted for consistency).
 */
export const flameTint = {
  10: "rgba(255, 92, 38, 0.10)",
  16: "rgba(255, 92, 38, 0.16)",
  24: "rgba(255, 92, 38, 0.24)",
} as const;
 ...
 * xxs-xs: badges, small chips (typically paired with small text/icons)
 * sm-md: standard card/input corners
 * lg-xl: large container corners, modals
 * hero: alias for xl (legacy key preserved for backwards compat)
 * pill: circular/fully rounded
 */
export const radii = {
  xxs: 4,
  xs: 8,
 ...
 * Use these tokens for padding, margin, gap across all components.
