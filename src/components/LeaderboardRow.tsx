    ...
    <View>
      ...
      >
        ...
        <View style={styles.pointsCol}>
          <Text style={[styles.points, { color: colors.text }, isTop3 && styles.pointsTop]}>
          ...
          <View style={styles.changeRow}>
            {entry.change > 0 && (
              <>
                ...
                <Text style={[styles.changeText, { color: Colors.palette.emerald }]}>
                  {entry.change}
                </Text>
              </>
            )}
            {entry.change < 0 && (
              <>
                ...
                <Text style={[styles.changeText, { color: Colors.palette.red }]}>
