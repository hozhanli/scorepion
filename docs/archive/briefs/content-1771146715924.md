...
# [section/Introduction](https://www.api-football.com/documentation-v3\#section/Introduction) Introduction
...
# [section/Authentication](https://www.api-football.com/documentation-v3\#section/Authentication) Authentication
...
Some frameworks _(especially in JS, nodeJS..)_ automatically add extra headers, you have to make sure to remove them in order to get a response from the API.

## [section/Authentication/API-SPORTS-Account](https://www.api-football.com/documentation-v3\#section/Authentication/API-SPORTS-Account) API-SPORTS Account
...
# [section/Architecture](https://www.api-football.com/documentation-v3\#section/Architecture) Architecture

![image](https://www.api-football.com/public/img/news/archi-beta.jpg)

# [section/Logos-Images](https://www.api-football.com/documentation-v3\#section/Logos-Images) Logos / Images

Calls to logos/images do not count towards your daily quota and are provided for free. However these calls are subject to a **rate per second & minute**, it is recommended to save this data on your side in order not to slow down or impact the user experience of your application or website. For this you can use **CDNs** such as [bunny.net](https://bunny.net/?ref=8r6al7jhm4).

We have a tutorial available [here](https://www.api-football.com/news/post/optimizing-sports-websites-bunnycdn-api-sports-image-storage-guide), which explains how to set up your own media system with **BunnyCDN**.
...
# [section/Sample-Scripts](https://www.api-football.com/documentation-v3\#section/Sample-Scripts) Sample Scripts
...
Also you will have to replace `XxXxXxXxXxXxXxXxXxXxXx` with your API-KEY provided in the [dashboard](https://dashboard.api-football.com/).

## [section/Sample-Scripts/C](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/C) C
...
## [section/Sample-Scripts/cURL](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/cURL) cURL
...
## [section/Sample-Scripts/Dart](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/Dart) Dart
...
## [section/Sample-Scripts/Go](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/Go) Go
...
## [section/Sample-Scripts/Java](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/Java) Java
...
## [section/Sample-Scripts/Javascript](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/Javascript) Javascript
...
## [section/Sample-Scripts/NodeJs](https://www.api-football.com/documentation-v3\#section/Sample-Scripts/NodeJs) NodeJs
...
$headers.Add("x-apisports-key", "XxXxXxXxXxXxXxXxXxXxXxXx")
...
request.addValue("XxXxXxXxXxXxXxXxXxXxXxXx", forHTTPHeaderField: "x-apisports-key")
...
![](https://api-sports-media-temp.b-cdn.net/widgets/football.png)

## [tag/Widgets/Security](https://www.api-football.com/documentation-v3\#tag/Widgets/Security) Security

Our widgets use your account's API-KEY, which must be specified in the `data-key` attribute of your widget configuration.

When using these widgets it is important to be aware that your API-KEY will be visible to the users of your site, it is possible to protect yourself from this by allowing only the desired domains or IP in our [dashboard](https://dashboard.api-football.com/profile?access).
...
You can further enhance security by completely hiding your API-KEY from the source code by following this [tutorial](https://www.api-football.com/news/post/how-to-optimize-widgets-cache-and-security-tutorial).

## [tag/Widgets/Caching-Data](https://www.api-football.com/documentation-v3\#tag/Widgets/Caching-Data) Caching Data
...
**Example:**
If a page triggers a single API request per visitor and you receive 80 visits to that page in one minute, this results in **80 API requests**. Over a full day, that can add up to **115 200 requests**.
...
## [tag/Widgets/Debugging](https://www.api-football.com/documentation-v3\#tag/Widgets/Debugging) Debugging
...
## [tag/Widgets/All-available-widgets](https://www.api-football.com/documentation-v3\#tag/Widgets/All-available-widgets) All available widgets
...
# [tag/Widgets/Before-You-Begin](https://www.api-football.com/documentation-v3\#tag/Widgets/Before-You-Begin) Before You Begin

## [tag/Widgets/Before-You-Begin/Dynamic-targeting](https://www.api-football.com/documentation-v3\#tag/Widgets/Before-You-Begin/Dynamic-targeting) Dynamic targeting
...
## [tag/Widgets/Before-You-Begin/Language](https://www.api-football.com/documentation-v3\#tag/Widgets/Before-You-Begin/Language) Language
...
> Example
>
> ![](https://api-sports-media-temp.b-cdn.net/widgets/lang.png)
...
## [tag/Widgets/Before-You-Begin/Predefined-themes](https://www.api-football.com/documentation-v3\#tag/Widgets/Before-You-Begin/Predefined-themes) Predefined themes
...
![](https://api-sports-media-temp.b-cdn.net/widgets/white.png)**Grey**

![](https://api-sports-media-temp.b-cdn.net/widgets/grey.png)

**Dark**

![](https://api-sports-media-temp.b-cdn.net/widgets/dark.png)**Blue**

![](https://api-sports-media-temp.b-cdn.net/widgets/blue.png)

## [tag/Widgets/Before-You-Begin/Custom-theme](https://www.api-football.com/documentation-v3\#tag/Widgets/Before-You-Begin/Custom-theme) Custom theme
...
|     |     |
| --- | --- |
| x-apisports-key<br>required | string<br>Your Api-Key |
...
"response": [{"predictions": {"winner": {"id": 1189,\
\
...
\
"league": {"form": "LDLDLDLWLWWLW",\
\
"fixtures": {"played": {"home": 6,\
\
"away": 7,\
\
"total": 13\
...
\
"league": {"form": "WLWLDLDLLLLWW",\
\
"fixtures": {"played": {"home": 7,\
\
"away": 6,\
\
"total": 13\
...
"response": [{"league": "Sudamericano U20",\
\
...
\
"values": [{"value": "Correa Caio Canedo",\
\
"odd": "67",\
\
"handicap": null,\
